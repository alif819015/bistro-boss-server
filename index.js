...
const sendPaymentConfirmationEmail = payment =>{
  transporter.sendMail({
    from: "mahmudhassan11752@gmail.com", // verified sender email
    to: "mahmudhassan11752@gmail.com", // recipient email
...
async function run() {
  try {
    ...
    /**
     * 1. do nit show secure links to those who should not see the links
...
app.get('/carts', verifyJWT, async(req,res) =>{
  ...
  res.send(result);
    ...
    app.get('/admin-stats', verifyJWT, verifyAdmin, async(req, res)=>{
      ...
      // bset way to get sum of the price field is to use group and operator
      /*
